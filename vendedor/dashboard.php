...
// Obtenemos la suma de las ventas del usuario y de las reservas
$sql = "SELECT Estado.valor_estado AS Estado, SUM(Producto.precio) AS total
FROM Operacion
JOIN Producto ON Operacion.id_producto = Producto.id
JOIN Estado ON Operacion.id_estado = Estado.id
                ...
                <div class="col-lg-12 mb-4 order-0">
                  <div class="card">
                    <div class="d-flex align-items-end row">
                      <div class="col-sm-7">
                        <div class="card-body">
                          <h5 class="card-title text-primary">Felicitaciones <?php echo $nombre; ?>! 🎉</h5>
                          <p class="mb-4">
                            Lograste un <span class="fw-bold">72%</span> de ventas mas hoy. 
                          </p>
