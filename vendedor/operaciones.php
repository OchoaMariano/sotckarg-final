...
$sql_op = "SELECT Operacion.*, Producto.nombre AS producto, Producto.precio, Usuario.nombre AS comprador, Estado.valor_estado AS estado FROM Operacion JOIN Producto ON Operacion.id_producto = Producto.id JOIN Usuario ON Operacion.id_usuario_comprador = Usuario.id JOIN Estado ON Operacion.id_estado = Estado.id WHERE Operacion.id_usuario_vendedor = '$id_usuario'";
                  ...
                  <table class="table">
                    ...
                    <?php foreach($operaciones as $operacion): ?>
                      <tr>
                        ...
                        <td><?= $operacion['id_usuario_comprador']; ?></td>
