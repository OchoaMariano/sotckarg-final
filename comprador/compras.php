...
$sql_op = "SELECT Operacion.*, Producto.nombre AS producto, Usuario.nombre AS vendedor, Estado.valor_estado AS estado FROM Operacion JOIN Producto ON Operacion.id_producto = Producto.id JOIN Usuario ON Operacion.id_usuario_vendedor = Usuario.id JOIN Estado ON Operacion.id_estado = Estado.id WHERE Operacion.id_usuario_comprador = '$id_usuario' AND Operacion.id_estado = 3";
$result_op = mysqli_query($conexion, $sql_op);
...
$operaciones = mysqli_fetch_all($result_op, MYSQLI_ASSOC);
        ...
        <div class="layout-page">
          ...
          <div class="content-wrapper">
            ...
            <div class="header__section row">
                <div class="col-8">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Compras /</span> Tus Compras</h4>
                </div>
                <div class="col-4">
              ...
              <!-- Responsive Table -->
              <div class="card">
                <h5 class="card-header">Operaciones</h5>
                <div class="table-responsive text-nowrap">
                  <table class="table">
                    ...
                    <?php foreach($operaciones as $operacion): ?>
                      <tr>
                        <th scope="row"><?= $operacion['id']; ?></th>
                        <td><?= $operacion['id_producto']; ?></td>
                        <td><?= $operacion['producto']; ?></td>
                        <td><?= $operacion['id_usuario_vendedor']; ?></td>
                        <td><?= $operacion['vendedor']; ?></td>
                        <td><span class="badge bg-label-success me-1"><?= $operacion['estado']; ?></span></td>    
                      </tr>
                    <?php endforeach; ?>
