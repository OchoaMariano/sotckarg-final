...
$sql_op = "SELECT Operacion.*, Producto.nombre AS producto, Usuario.nombre AS vendedor, Estado.valor_estado AS estado FROM Operacion JOIN Producto ON Operacion.id_producto = Producto.id JOIN Usuario ON Operacion.id_usuario_vendedor = Usuario.id JOIN Estado ON Operacion.id_estado = Estado.id WHERE Operacion.id_usuario_comprador = '$id_usuario'";
...
>
  <head>
    ...
    <title>Operaciones | Stockarg</title>
